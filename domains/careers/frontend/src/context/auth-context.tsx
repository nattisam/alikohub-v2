...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const loginMutation = useMutation({
    mutationFn: async (payload: LoginPayload) => {
      const res = await authApiClient.post<AuthResponse>("/auth/login", payload)
      return res.data
    },
  ...
  const registerMutation = useMutation({
    mutationFn: async (payload: RegisterPayload) => {
      const res = await authApiClient.post<AuthResponse>("/auth/register", payload)
      return res.data
    },
    onSuccess: handleAuthSuccess,
  })
  ...
  const value: AuthContextValue = {
    ...
    isLoading: !bootstrapped || loginMutation.isPending || registerMutation.isPending,
    login,
    register,
    logout,
  }
