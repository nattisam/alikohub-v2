      ...
      <div className="w-full min-h-screen bg-stone-50">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
          <div className="rounded-2xl bg-white border border-gray-200 p-12 text-center shadow-sm">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Failed to load applicants</h2>
            <p className="text-gray-500 mb-6">Something went wrong while loading the applicants.</p>
            <button 
              onClick={() => refetch()}
  ...
  return (
    <div className="w-full min-h-screen bg-stone-50">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Applications for {jobTitle}</h2>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">{application.userId}</p>
                    </div>
                    <div>
