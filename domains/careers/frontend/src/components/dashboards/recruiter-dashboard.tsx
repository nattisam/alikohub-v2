      ...
      <div className="w-full min-h-screen bg-stone-50">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
          <div className="rounded-2xl bg-white border border-gray-200 p-12 text-center shadow-sm">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Failed to load job postings</h2>
            <p className="text-gray-500 mb-6">Something went wrong while loading your job postings.</p>
            <button 
              onClick={() => refetch()}
    ...
    <div className="w-full min-h-screen bg-stone-50">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="flex items-center justify-between mb-10">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-3">Job Postings</h1>
            <p className="text-gray-500">Manage your job listings and review applicants</p>
          </div>
          <button
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm mb-3">{job.department || 'General'}</p>
                ...
                <div className="flex items-center justify-between pt-5 border-t border-gray-100">
                  <div className="flex items-center gap-6 text-sm">
                    <div>
                      <p className="text-gray-400 text-xs font-semibold uppercase tracking-widest">Applicants</p>
                      <p className="text-lg font-bold text-indigo-600">{job.applicants || 0}</p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-xs font-semibold uppercase tracking-widest">Posted</p>
                      <p className="text-gray-700 text-sm">{job.postedDate || 'N/A'}</p>
                    </div>
                  </div>
