"use client"
import { Briefcase, BarChart3, FileText } from "lucide-react"
...
export function Navigation({ userRole }: NavigationProps) {
  ...
  return (
    <aside className="hidden md:flex w-64 bg-white/80 border-r border-sidebar-border shadow-sm backdrop-blur-sm flex-col">
      {/* Logo / Brand */}
