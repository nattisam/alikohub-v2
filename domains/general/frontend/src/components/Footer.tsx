...
export function Footer() {
  return (
    <footer id="contact" className="border-t border-white/5 bg-header py-16 text-header-foreground transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-header-foreground/80">
            ...
            <div className="mt-6 space-y-2 text-sm text-header-foreground/80">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="font-heading text-sm font-semibold uppercase tracking-wider text-header-foreground mb-4">
                {title}
              </h4>
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm text-header-foreground/80 transition-colors hover:text-primary">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-header-foreground/60">
