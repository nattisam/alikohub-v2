    ...
    <div className="flex flex-col items-center justify-center py-16 px-4 w-full">
      <div className="bg-white border-2 border-dashed border-gray-100 rounded-3xl p-12 max-w-lg w-full text-center shadow-sm">
        ...
        {showAction && actionText && onAction && (
          <button
            onClick={onAction}
            className="bg-[#3E92D1] hover:bg-[#2d7db8] text-white font-bold py-3.5 px-8 rounded-2xl transition-all shadow-lg shadow-blue-100 transform hover:scale-105 active:scale-95 flex items-center gap-2 mx-auto"
          >
            <FaPlus /> {actionText}
          </button>
        )}
