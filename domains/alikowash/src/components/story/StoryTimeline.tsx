...
export function StoryTimeline({
  ...
  return (
    <div
      id="story-timeline"
      className="sticky top-16 md:top-20 z-40 bg-background/90 backdrop-blur-md border-b border-border py-3 md:py-4 overflow-hidden transition-all duration-300"
    >
      <div className="container-main">
        ...
        <div className="relative">
          ...
          <div className="relative flex items-center justify-between">
            {chapters.map((chapter, index) => {
              const yearStr = chapter.year ? chapter.year.toString() : "2024";
              const Icon = chapterIcons[yearStr] || Droplets;
              const isActive = activeChapter === chapter.id;
              const isPast = activeIndex > index;
              const colors = chapterColors[yearStr] || chapterColors["1995"];
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    className={cn(
                      "relative w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center transition-all duration-500 border-2",
                      isActive
                  ...
                  >
                    ...
                    {/* Hover glow */}
                    <motion.div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </motion.div>
                  ...
                  >
                    <motion.span
                      className={cn(
                        "block text-lg md:text-2xl font-display font-bold transition-all duration-300 px-2 py-0.5 rounded-lg",
                        isActive
        ...
        {/* Removed Journey Progress Text to save vertical space when sticky */}
      </div>
    </div>
  );
}
