...
const team = [
  {
    ...
    role: "Co-Founder & CEO",
    image: boniAliko,
    description: "Leading Aliko Wash with a vision for sustainable water access across Ethiopia.",
  },
  {
    name: "Birassa Aliko",
    role: "Co-Founder & COO",
    image: birassaAliko,
    description: "40+ years of water engineering expertise, continuing our father's legacy.",
  },
  {
    name: "Abdi Birassa",
    role: "CTO",
    image: abdiBirassa,
    description: "Driving technological innovation in water infrastructure solutions.",
  },
  {
    name: "Biniyam Birassa",
    role: "Program Director",
    image: biniyamBirassa,
    description: "Overseeing project implementation and community engagement programs.",
  },
  {
    name: "Natnael Tariku",
    role: "Senior Project Engineer",
    image: natnaelTariku,
    description: "Engineering excellence in reservoir and water system construction.",
  },
  {
    name: "Bonsa Birassa",
    role: "Marketing Manager",
    image: bonsaBirassa,
    description: "Building partnerships and expanding Aliko Wash's reach and impact.",
  },
  {
    name: "Lensa Aliko",
    role: "MPH Candidate, Johns Hopkins",
    image: lensaAliko,
    description: "Sanitation and Hygiene Advisor bringing public health expertise to our programs.",
  },
  {
    name: "Baati Aliko",
    role: "Director of Strategic Partnerships & Development",
    image: baatiAliko,
    description: "Driving strategic partnerships and development initiatives to expand our impact.",
  },
];
