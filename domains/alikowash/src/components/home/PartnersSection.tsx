...
const otherPartnerGroups = [
  {
    ...
    icon: Building2,
    partners: [
      { name: "Aliko Construction", fullName: "Infrastructure & WASH Construction", logo: alikoConstructionLogo },
...
export function PartnersSection() {
  ...
  return (
    <section className="section-padding bg-secondary/30 overflow-hidden" ref={ref}>
