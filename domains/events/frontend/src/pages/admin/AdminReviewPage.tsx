          ...
          <div className="flex gap-4">
            {!isEditing && (
              <>
                <button
                  ...
                  className="px-6 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-full font-bold hover:bg-gray-50 transition text-sm shadow-sm"
                >
                  Edit & Refine
                </button>
                <button
                  onClick={() => setShowRejectModal(true)}
                  className="px-6 py-2.5 bg-red-50 text-red-600 rounded-full font-bold hover:bg-red-100 transition text-sm border border-red-100"
                >
                  Reject
                </button>
                <button
                  ...
                  className="px-6 py-2.5 bg-[#0a66c2] text-white rounded-full font-bold hover:bg-[#004182] transition shadow-md shadow-blue-100 disabled:bg-gray-400 text-sm"
                >
                  Approve & Publish
                </button>
              </>
            ...
            {isEditing && (
              <button
                ...
                className="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-full font-bold hover:bg-gray-200 transition text-sm"
              >
                Cancel Edit
              </button>
            )}
        ...
        {isEditing ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-8">
              {post.coverImage && (
                <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-200 aspect-video bg-white">
                  <img
                    src={post.coverImage}
                    alt={post.title}
            ...
            <div className="space-y-6">
              {post.type === PostType.EVENT && (
                <div className="bg-[#0a66c2] p-8 rounded-2xl text-white shadow-xl shadow-blue-100">
                  <h3 className="text-xl font-bold mb-6 flex items-center border-b border-white/20 pb-4">
                    <svg
                  ...
                  <div className="space-y-6">
                    <div>
                      <p className="text-blue-100 text-[10px] font-bold uppercase tracking-wider mb-2">
                        Date & Time
                      </p>
        ...
        {showRejectModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl">
              ...
              <textarea
                className="w-full h-40 px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none transition mb-6 resize-none"
