...
const TeacherApplicationsDashboard: React.FC = () => {
  ...
  const handleApprove = async (applicationId: string) => {
    const { value: text, isConfirmed } = await Swal.fire({
      ...
      inputPlaceholder: "Type your approval notes here...",
      inputAttributes: {
        "aria-label": "Type your approval notes here",
      },
    ...
    if (isConfirmed && text) {
      approveMutation.mutate({ applicationId, data: { reviewNotes: text } });
    }
  };
  ...
  const handleReject = async (applicationId: string) => {
    ...
    if (isConfirmed && text) {
      rejectMutation.mutate({ applicationId, data: { reviewNotes: text } });
    }
  };
                        ...
                        {application.status === "PENDING" ? (
                          <div className="flex justify-end space-x-2">
                            ...
                            >
                              ...
                              (approveMutation.variables as any)
                            ...
                            >
                              ...
                              (rejectMutation.variables as any)
                                ?.applicationId === application.id ? (
                                <span className="flex items-center">
                                  <span className="h-3 w-3 rounded-full border-2 border-white border-t-transparent animate-spin mr-1"></span>
                                  Rejecting...
