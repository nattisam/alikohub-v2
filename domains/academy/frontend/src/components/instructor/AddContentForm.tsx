...
const AddContentForm: React.FC<AddContentFormProps> = ({ lessonId, onContentAdded, onCancel }) => {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                Content Title *
                <FaInfoCircle className="ml-2 text-gray-400" title="Enter a descriptive title for your content" />
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                Content Type
                <FaInfoCircle className="ml-2 text-gray-400" title="Select the type of content you're adding" />
              </label>
              <select
                name="type"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                Content URL *
                <FaInfoCircle className="ml-2 text-gray-400" title="Enter the URL or text content for this item" />
              </label>
              <input
                type="text"
