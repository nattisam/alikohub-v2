...
const AllCourses: React.FC<AllCoursesProps> = ({ 
  ...
  if (isLoading || enrollmentsLoading) {
    return (
      <div className={`${className} bg-white rounded-lg shadow-sm border border-gray-100 p-8 flex items-center justify-center`}>
  ...
  if (shouldShowError) {
    return (
      <div className={`${className} bg-white rounded-lg shadow-sm border border-gray-100 p-8 text-center`}>
        <h2 className="text-lg font-semibold text-gray-900 mb-2">Failed to load courses</h2>
        <p className="text-gray-500 text-sm mb-4">There was an issue fetching the course list.</p>
        <button 
  ...
  return (
    <div className={`${className} bg-white rounded-lg shadow-sm border border-gray-100 p-6`}>
      <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-50">
        <div>
           <h2 className="text-xl font-semibold text-gray-900">All Courses</h2>
           <p className="text-xs text-gray-400 mt-1">Explore our latest available training programs</p>
        </div>
