...
export const teachingScheduleApi = {
  ...
  getInstructorSchedules: () =>
    academyApi.get<TeachingSchedule[]>(
      "/academy/teaching-schedules/instructor",
    ),

  // Get schedules for a specific course
  getCourseSchedules: (courseId: number) =>
    academyApi.get<TeachingSchedule[]>(
      `/academy/teaching-schedules/course/${courseId}`,
    ),

  // Create a new teaching schedule
  createSchedule: (data: CreateTeachingScheduleDto) =>
    academyApi.post<TeachingSchedule>("/academy/teaching-schedules", data),

  // Update an existing teaching schedule
  updateSchedule: (id: number, data: UpdateTeachingScheduleDto) =>
    academyApi.put<TeachingSchedule>(`/academy/teaching-schedules/${id}`, data),

  // Delete a teaching schedule
  deleteSchedule: (id: number) =>
    academyApi.delete(`/academy/teaching-schedules/${id}`),

  // Get a specific teaching schedule by ID
  getScheduleById: (id: number) =>
    academyApi.get<TeachingSchedule>(`/academy/teaching-schedules/${id}`),
};
