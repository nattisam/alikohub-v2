                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900 flex items-center gap-3">
                                {course.title}
                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${!course.price || course.price === 0 ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}`}>
                            ...
                            <div className="mt-4 flex flex-wrap gap-6 text-sm text-gray-500">
                                ...
                                <span className="flex items-center gap-2">
                                    ...
                                    {estimatedHours}h {course.estimatedTime ? course.estimatedTime % 60 : 0}m
                                </span>
                                <span className="flex items-center gap-2">
                                    <Star size={16} className="text-yellow-400 fill-yellow-400" />
                                    {course.rating?.toFixed(1) || "New"} ({course.enrolledNum || 0} enrolled)
                                </span>
                            </div>
                                ...
                                <div key={module.id} className="border border-gray-200 rounded-lg overflow-hidden">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            {expandedModules[module.id] ? <ChevronDown size={18} className="text-gray-500" /> : <ChevronRight size={18} className="text-gray-500" />}
                                            <div>
                                                <h3 className="font-medium text-gray-900">Module {idx + 1}: {module.title}</h3>
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow p-6 sticky top-6">
                    ...
                    <div className="pt-6 border-t border-gray-100 space-y-4">
                        <h4 className="font-semibold text-sm text-gray-900">This course includes:</h4>
