...
const AcademyHomePage = () => {
  ...
  const validTrendingCourses = Array.isArray(trendingCourses)
    ? trendingCourses
    : [];
    ...
    <div className="pt-16">
      ...
      <div className="overflow-hidden">
                    ...
                    >
                      <div className="p-6">
                        ...
                        <p className="text-gray-600 mb-4">
                          Discover our comprehensive {category.toLowerCase()}{" "}
        ...
        {!loading &&
          ...
          categories.length === 0 &&
          allCourses.length > 0 && (
            <CoursesList courses={allCourses} category="All Courses" />
          )}
