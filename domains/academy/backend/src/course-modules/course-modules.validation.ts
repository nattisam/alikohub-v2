...
export const CreateCourseModuleSchema = Joi.object({
  dto: Joi.object({
    title: Joi.string().required().description('The title of the course module'),
    description: Joi.string().required().description('A detailed description of the module content'),
    courseId: Joi.number().integer().required().description('The unique identifier of the course this module belongs to')
  }).required().description('Course module creation details'),
...
export const UpdateCourseModuleSchema = Joi.object({
  id: Joi.number().integer().required().description('The unique identifier of the module to update'),
  dto: Joi.object({
  ...
  }).required().description('Course module update details'),
...
export const ModuleIdSchema = Joi.object({
  id: Joi.number().integer().required().description('The unique identifier of the module'),
  user: Joi.any().required().description('The authenticated user')
