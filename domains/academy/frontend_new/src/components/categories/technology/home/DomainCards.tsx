...
const domains = [
  {
    ...
    href: '/programs?category=Software+Engineering',
  ...
  },
  {
    ...
    href: '/programs?category=Data+%26+Analytics',
  ...
  },
  {
    ...
    image: heroAiMl,
    href: '/programs?category=AI+%26+Machine+Learning',
    accent: 'from-aliko-blue/80 to-aliko-blue/40',
    hoverBorder: 'hover:ring-aliko-blue/60',
  },
  {
    ...
    href: '/programs?category=Cloud+%26+DevOps',
  ...
  },
  {
    ...
    image: heroLowcode,
    href: '/programs?category=Low-Code+%26+Business+Apps',
  ...
  },
  {
    ...
    href: '/programs?category=Cybersecurity',
    ...
    <section className="section-padding bg-gradient-to-b from-[hsl(207,45%,16%)] to-[hsl(207,50%,12%)] relative">
      <div className="container-padding mx-auto max-w-7xl">
        <div className="text-center mb-14">
          <p className="text-sm font-bold text-secondary uppercase tracking-widest mb-4">Explore Domains</p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Choose Your Path
          </h2>
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Six in-demand tech domains — each with career tracks and short courses to get you job-ready.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {domains.map((domain) => (
            ...
            >
              ...
              />
              <div className={`absolute inset-0 bg-gradient-to-t ${domain.accent} via-black/50 to-black/20`} />
