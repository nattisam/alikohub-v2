  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col h-screen overflow-hidden text-slate-900">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={cn(
            "bg-surface-container-low shadow-sm docked left-0 flex flex-col p-6 gap-4 sticky overflow-y-auto z-40 transition-all duration-300 h-[calc(100vh-56px)] shrink-0",
            isSidebarOpen
              ? "w-[320px] lg:w-80 translate-x-0"
              : "w-0 -translate-x-full lg:w-0 lg:p-0 border-none",
          )}
        >
          {isSidebarOpen && (
            <>
