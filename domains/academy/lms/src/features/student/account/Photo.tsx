  ...
  const handleFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      toast({
        ...
        description: "Click save to apply your new photo.",
      });
    }
  };
      ...
      <div className="section-container max-w-2xl py-10">
        ...
        <div className="bg-card rounded-xl border p-8">
          <p className="text-sm text-muted-foreground mb-6">
            Add a nice photo of yourself for your profile. Image must be at
            least 200×200 pixels.
          </p>
          <div className="flex flex-col items-center gap-6">
            ...
            {preview && (
              <Button
                className="mt-2"
                onClick={() => toast({ title: "Photo saved!" })}
              >
                Save Photo
              </Button>
            )}
