...
import type { ExtendedCurrentUser, Task } from "../components/types";
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Approve project milestones, change orders, and deliverables
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-4">
                  {pendingApprovals.map((task: Task) => (
                    <div
                      key={task.id}
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <span
                            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-2 ${getStatusColor(task.status)}`}
                          >
