...
import type { Contract, ChangeOrder } from "../components/types";
...
const FinancialTracking: React.FC = () => {
  ...
  const loading = loadingProjects || loadingContracts;

  // Filter projects and contracts based on selection
  const projects = selectedProject
    ? allProjects.filter((p: any) => p.id === selectedProject)
    : allProjects;

  const contracts = selectedProject
    ? allContracts.filter((c: Contract) => c.projectId === selectedProject)
    : allContracts;
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Monitor budgets, expenses, and financial reports for your projects
        </p>
      </div>
        ...
        <>
          ...
          {selectedProject ? (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Please select a project to view financial information.
              </p>
            </div>
          )}
        </>
